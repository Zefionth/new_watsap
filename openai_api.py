...
def get_names(query: str) -> str:
    chat_completion = client.chat.completions.create(
        model="gpt-4o", 
        messages=[
            {"role": "system", "content": "Пользователь хочет посмотреть фильмы, 3-5 штук. Отвечай в следующем виде словаря и никак иначе: {name_1: 'название фильма 1', name_2:'название фильма 2', и так далее}"},
