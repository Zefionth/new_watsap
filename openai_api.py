...
def get_names(query, category):
    if category == 'movies':
        chat_completion = client.chat.completions.create(
            ...
            {
                "role": "system",
                "content": "Пользователь хочет посмотреть фильмы, аниме запрещены. До 10 штук. "
        ...
        chat_completion = client.chat.completions.create(
            ...
            {
                "role": "system",
                "content": "Пользователь хочет посмотреть аниме, обычные фильмы запрещены, До 10 штук. "
                    "Отвечай в следующем виде словаря и никак иначе: "
                    "{name_1: 'название фильма 1', name_2:'название фильма 2', и так далее}. "
                    "Если запрос непонятный, несвязный, пиши {}"
            },
