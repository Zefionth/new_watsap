...
def get_names(query: str, category: str) -> dict:
    if category == 'movies':
        chat_completion = client.chat.completions.create(
            ...
            {
                "role": "system",
                "content": "Пользователь хочет посмотреть фильмы по обобщенному описанию, аниме запрещены. До 5 штук. "
        ...
        chat_completion = client.chat.completions.create(
            ...
            {
                "role": "system",
                "content": "Пользователь хочет посмотреть именно аниме по обобщенному описанию, До 5 штук. "
